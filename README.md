...
There is a compiler directive to control whether to use GDI+ or WIC+Custom Resize to load and resize the images. 
Since GDI+ code is serialized with a global lock, it's not well suited for background threads.
...
Flag images by Flagpedia @ https://flagpedia.net
RockTV & Action Central images created using AI.
